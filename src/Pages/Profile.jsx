...
fetch("http://localhost:5002/api/auth/resend-confirmation", requestOptions)
  .then((response) => response.text())
  .then((result) =>{
    toast.success("We've sent you an email! Please check your inbox (and spam folder) for further instructions.");
  })
    ...
    >
      Confirm Your Account
                ...
                <div className="card-footer">
                  ...
                  <a href="page-forgot-password.html" className="btn-link">
